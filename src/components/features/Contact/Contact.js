...
const Contact = () => {
  return (
    <Section id="contact" background="white" className="py-32 relative overflow-hidden">
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="mt-8 space-y-4">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-accent-magenta/10 rounded-full flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <h4 className="font-display font-bold text-xl text-dark-900">London</h4>
                  <p className="text-dark-600 mt-1">UXBRIDGE ROAD LONDON W12 8LH</p>
                </div>
              </div>

              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-accent-cyan/10 rounded-full flex items-center justify-center flex-shrink-0">
                  <svg className="w-6 h-6 text-accent-cyan" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                </div>
                <a href="tel:+447789772413" className="font-semibold text-dark-900 hover:text-accent-magenta transition-colors">
                  +44 7789772413
                </a>
              </div>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="mt-8">
              ...
              <motion.a
                ...
                className="inline-flex items-center gap-3 px-6 py-4 rounded-full bg-gradient-to-r from-accent-cyan/30 via-accent-magenta/20 to-accent-violet/30 border border-accent-cyan/30 hover:border-accent-cyan/50 transition-all duration-300 group"
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
                <span className="w-8 h-8 bg-dark-900 rounded-full flex items-center justify-center">
                  <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                </span>
                <span className="font-semibold text-dark-900 group-hover:text-dark-700 transition-colors">
            ...
            <motion.div variants={fadeInUp} className="mt-12 space-y-4">
              ...
              <div className="flex gap-4 mt-6">
                {['twitter', 'instagram', 'tiktok', 'linkedin'].map((social) => (
                  <motion.button
                    key={social}
                    className="w-12 h-12 rounded-full bg-light-100 border border-light-300 flex items-center justify-center hover:bg-accent-magenta/10 hover:border-accent-magenta/30 transition-all"
